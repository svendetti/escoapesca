...
BEGIN
  ...
  -- Supabase protegge i DELETE privi di WHERE anche dentro le RPC.
  -- La clausola esplicita mantiene intenzionale e verificabile il reset totale.
  ...
  DELETE FROM public.app_events WHERE true;
  GET DIAGNOSTICS events_deleted = ROW_COUNT;

  DELETE FROM public.trip_feedback WHERE true;
  GET DIAGNOSTICS feedback_deleted = ROW_COUNT;

  DELETE FROM public.trip_private_details WHERE true;
  GET DIAGNOSTICS private_details_deleted = ROW_COUNT;

  DELETE FROM public.trip_participants WHERE true;
  GET DIAGNOSTICS participations_deleted = ROW_COUNT;

  DELETE FROM public.fishing_trips WHERE true;
